 ...
 * It extends the abstract CommandGroup class and adds specific commands to the group.
 * Each command represents a different action that can be performed by the CLIController.
 *
...
public class CLICommandGroup extends CommandGroup {
  ...
  /**
   * Constructs a new CLICommandGroup with a set of specific commands.
   * The commands are added to the group in the constructor.
   *
